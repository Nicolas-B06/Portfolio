      ...
      <div className="container mx-auto text-center">
        <p className="text-lg mb-4 lg:p-0 p-4">
          ...
          <a
            ...
            className="bg-transparent text-[var(--accent)] hover:underline"
          >
        ...
        <div className="flex justify-center space-x-6 mb-4">
          <a
            ...
            className="bg-transparent hover:text-[var(--accent)]"
          >
            <svg
              className="w-6 h-6"
              fill="currentColor"
        ...
        <p className="text-gray-400">
          &copy; {new Date().getFullYear()} Mon Portfolio. {t("footerRights")}
        </p>
      </div>
    </footer>
  );
